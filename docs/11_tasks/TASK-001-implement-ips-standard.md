...
execution_plan: docs/21_execution_plans/EP-TASK-001-implement-ips-standard.md
related_adrs:
...
Use `docs/21_execution_plans/EP-TASK-001-implement-ips-standard.md` before coding or deployment changes.
