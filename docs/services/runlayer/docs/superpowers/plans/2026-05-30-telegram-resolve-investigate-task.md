...
```bash
grep -n "exports" /home/ssf/Documents/Github/runlayer/src/worker/worker.module.ts
```
...
```bash
gh issue comment 9 --repo speakASAP/runlayer --body "## Completed
...
gh issue close 9 --repo speakASAP/runlayer
```
