...
You may request deletion of your personal data at any time. This includes data you provided directly and data we received from third-party platforms (such as Facebook Login, Google Sign-In, or other social or authentication providers).

### **How to request data removal**

- **Email:** Send a request to <privacy@statex.com> (or <contact@alfares.cz>) with the subject "Data removal request" and your email address or user identifier used for our services.
- **From Facebook:** If you signed in with Facebook, you can also initiate a data deletion request via **Facebook Settings → Apps and Websites**; we will receive and process that request and delete all data we hold that we received from or associated with your use of Facebook with our services.

### **What we do**

- We will delete or anonymize your personal data (including any data obtained via Facebook or other platforms) within **30 days** of a verified request, except where we must retain data for legal or regulatory reasons.
- We will send you a confirmation once the removal is complete (or explain any retention that applies).

### **GDPR**

This process supports your **Right to Erasure** under GDPR; see "Your Privacy Rights" above for other rights.
...
**This Privacy Policy is effective as of January 15, 2026. For questions about this policy or our data practices, please contact us at <privacy@statex.com>.**
