...
- Authenticate ingestion and retrieval exclusively under the [Service Identity Consumer Standard](../auth-microservice/docs/SERVICE_IDENTITY_CONSUMER_STANDARD.md); expose public health and sanitized central logging.
