...
### New column on `business_orchestrator.tasks`
...
New TypeORM migration: `AddUserContextToTasks` — `ALTER TABLE business_orchestrator.tasks ADD COLUMN user_context JSONB NOT NULL DEFAULT '{"distilled":"","thread":[]}'`.
