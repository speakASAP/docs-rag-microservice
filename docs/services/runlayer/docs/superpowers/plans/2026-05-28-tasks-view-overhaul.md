...
Open https://runlayer.alfares.cz/ in browser and confirm project cards no longer show "View tasks" or "View queue" buttons. The mode badge and toggle should still be there.
...
Navigate to https://runlayer.alfares.cz/tasks. Confirm Table/Dependency Graph toggle buttons appear. Click "Dependency Graph" — confirm the Cytoscape graph renders with task nodes and dependency edges.
...
1. Navigate to https://runlayer.alfares.cz/tasks
...
Navigate to https://runlayer.alfares.cz/tasks, switch to "Dependency Graph" view, click a node. Confirm the side info panel appears with the "Open detail →" link. Click it — confirm it navigates to the task detail page with full metadata.
