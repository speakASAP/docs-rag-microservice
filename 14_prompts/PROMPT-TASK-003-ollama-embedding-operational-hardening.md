...
Read `21_execution_plans/EP-TASK-003-ollama-embedding-operational-hardening.md`,
`13_context_packages/CP-TASK-003-ollama-embedding-operational-hardening.md`,
...
Record results in `12_validation/VAL-TASK-003-ollama-embedding-operational-hardening.md`.
