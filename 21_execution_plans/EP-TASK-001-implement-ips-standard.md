...
## Project invariants
References `DRAG-INV-001` through `DRAG-INV-005` in `17_governance/PROJECT_INVARIANTS.md`.
...
## Validation Plan
Record command evidence in `12_validation/VAL-TASK-001-ips-adoption.md` and generated JSON reports under the validation reports directory.
