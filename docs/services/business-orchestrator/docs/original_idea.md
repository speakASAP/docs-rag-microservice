# Project OS vision (formerly Business Orchestrator)
...
The `business-orchestrator` microservice is the central layer that manages:
...
`business-orchestrator` should become a **fully visual operating system for digital businesses**, where one founder can:
