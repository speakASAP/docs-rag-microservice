# Master plan — Goal-driven AI execution platform (business-orchestrator + pilot)

**Saved:** 2026-04-11  
**Scope:** `business-orchestrator` (control plane) → pilot `flipflop-service` (second phase).  
...
**Pilot order:** (1) `business-orchestrator` dogfood → (2) `flipflop-service` after pipeline is SAFE.
...
- Flipflop enabled only after metrics stable on business-orchestrator.
