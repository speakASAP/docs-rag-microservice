...
Append to `/home/ssf/Documents/Github/business-orchestrator/.env`:
...
```bash
grep -n "api/dashboard\|fetch.*dashboard" /home/ssf/Documents/Github/business-orchestrator/public/app.js
```
...
```bash
grep -n "function goBack\b" /home/ssf/Documents/Github/business-orchestrator/public/app.js
```
...
```bash
grep -n "portfolio-feedback\|setPortfolioFeedback" /home/ssf/Documents/Github/business-orchestrator/public/app.js | head -10
```
...
```bash
kubectl patch secret business-orchestrator-secret -n statex-apps \
  --type merge \
...
```bash
curl -s -o /dev/null -w "%{http_code}" https://orchestrator.alfares.cz/api/dashboard
```
...
curl -s -o /dev/null -w "%{http_code}" \
  ...
  https://orchestrator.alfares.cz/api/dashboard
```
...
Open `https://orchestrator.alfares.cz/` in a browser:
