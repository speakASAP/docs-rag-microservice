...
```bash
# Database
DATABASE_URL=postgresql://user:password@db-server-postgres.statex-apps.svc.cluster.local:5432/statex_portal
...
# External Services
SUBMISSION_SERVICE_URL=http://statex-submission-service-blue:8000
# Ports configured in respective .env files
NOTIFICATION_SERVICE_URL=http://notifications-microservice:${PORT:-3368}  # notifications-microservice/.env
AI_SERVICE_URL=http://ai-microservice-orchestrator:${AI_ORCHESTRATOR_PORT:-3380}  # ai-microservice/.env

# Security
ALLOWED_HOSTS=localhost,127.0.0.1,portal.alfares.cz
CORS_ALLOWED_ORIGINS=http://localhost:${FRONTEND_PORT:-3602},https://alfares.cz  # statex/.env
