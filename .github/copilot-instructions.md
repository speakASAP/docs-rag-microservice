# Copilot Instructions — `docs-rag-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/docs-rag-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/docs-rag-microservice.git`, branch `main`.
