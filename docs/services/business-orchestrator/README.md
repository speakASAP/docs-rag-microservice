...
- NestJS 10, TypeScript 5, TypeORM 0.3 (PostgreSQL schema `business_orchestrator`)
...
- Implementation plan and file map: `docs/superpowers/plans/2026-04-05-business-orchestrator-mvp.md`
