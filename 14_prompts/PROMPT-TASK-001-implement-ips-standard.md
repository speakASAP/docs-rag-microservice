...
upstream:
  - 13_context_packages/CP-TASK-001-implement-ips-standard.md
downstream: []
related_adrs:
...
Follow `21_execution_plans/EP-TASK-001-implement-ips-standard.md`.
...
## Expected output
Updated repository files and validation evidence under `12_validation/` and the validation reports directory.

## Validation
Use the commands above and record the results in `12_validation/VAL-TASK-001-ips-adoption.md`.
