...
- **Container orchestrace**: Docker Compose a Docker container management
...
- **Docker Compose**: Container orchestrace platforma
- **Docker Swarm**: Docker-native orchestrace
- **Docker Compose**: Docker Compose package manager
