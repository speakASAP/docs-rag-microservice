...
downstream:
  - docs/21_execution_plans/EP-TASK-002-restore-ollama-embedding-connectivity.md
goal_impact: docs/22_goal_impact/GOAL-IMPACT-TASK-002.md
execution_plan: docs/21_execution_plans/EP-TASK-002-restore-ollama-embedding-connectivity.md
related_adrs:
  - docs/07_decisions/ADR-001-documentation-rag-service.md
```
...
Use `docs/21_execution_plans/EP-TASK-002-restore-ollama-embedding-connectivity.md`
