...
## B. business-orchestrator — product & policy (repo root)
...
## C. business-orchestrator — technical deep dive
...
Repo path from workspace root: `flipflop-service/` (sibling of `business-orchestrator/`).

## F. Runtime configuration

| File | Purpose |
| ---- | ------- |
| [business-orchestrator/.env.example](../../.env.example) | `DAILY_DIGEST_*`, service URLs, and runtime config keys |
...
| [scripts/orch-business-orchestrator-health.sh](../../scripts/orch-business-orchestrator-health.sh) | Compatibility wrapper for `orch-project-health.sh business-orchestrator` |
...
./scripts/orch-project-health.sh business-orchestrator  # self-dogfood project health report
